 ...
 */
async function listar(): Promise<Administrador[]> {
 ...
 */
async function buscarPorId(id: number): Promise<Administrador> {
 ...
 */
async function salvar(administrador: Administrador, id: number): Promise<Administrador> {
